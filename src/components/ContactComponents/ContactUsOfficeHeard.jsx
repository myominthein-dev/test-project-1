...
const ContactUsOfficeHeard = () => {
  return (
    <div className=" flex justify-center items-center flex-col">
      ...
      <h1 className="  text-[30px] lg:text-[50px] my-5  font-[700] leading-[66.45px]">
        <span className=" text-[#6596A1]">Where</span> we are?
      </h1>
      <p className=" w-[350px] text-xs lg:text-[16px]  lg:w-[478px] text-center  font-[600] leading-[24px] text-[#7F7D7D]">
